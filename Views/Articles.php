...
$liste=$article1C->afficherArticle();
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-wrapper">
    ...
    <section class="inner-banner">
        <div class="container">
            <h2 class="inner-banner__title">Les Articles</h2><!-- /.inner-banner__title -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    ?>
                                        ...
                                        <a href="article.php?id=<?php echo $item['id']; ?>" class="blog-one__link">Voir plus <span>+</span></a>
                                        <!-- /.blog-one__link -->
