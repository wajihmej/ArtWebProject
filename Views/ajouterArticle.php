...
<div class="page-wrapper">
    ...
    <section class="inner-banner">
        <div class="container">
            <h2 class="inner-banner__title">Ajouter Article</h2><!-- /.inner-banner__title -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-details__review-form">
                        <h3 class="product-details__review-form__title">Ajouter un Article</h3>
                        <form  method="post" class="contact-one__form" id="form_article">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                <input class="thm-btn login-form__btn login-form__btn-two" type="submit" value="Poster un article" name="ajout" id="ajout">
                                </div><!-- /.col-lg-12 -->
                            </div><!-- /.row -->
                        </form>
                    </div>
