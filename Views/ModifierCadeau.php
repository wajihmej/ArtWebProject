...
if( isset($_POST['nom']) and isset($_POST['prix']) ){
    ...
    $cadeauxC->UpdateImgCadeauximg($_GET['id'],$folder);
...
//Partie3
$cadeauxC = new CadeauxC();
$cadeauxC->modifierCadeaux($cadeaux,$_GET['id']);
    ...
    <div class="page-wrapper">
        ...
        <section class="login-form">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="login-form__title">Modifier Cadeau</h3><!-- /.login-form__title -->
                        <form action="#" class="login-form__form" method="post" enctype="multipart/form-data" id="from_cadeau" >
                            ...
                            <div class="login-form__field">
                                <input type="number" name="prix" placeholder="Prix" value="<?PHP echo $prix ?>">
                                <i class="fa fa-user"></i>
                            </div><!-- /.login-form__field -->
                            <div class="login-form__field">
