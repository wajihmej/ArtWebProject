...
$liste=$cadeauxC->afficherMesCadeaux($_SESSION['idclient']);
$resultc=$cadeauxC->countCadeaux($_SESSION['idclient']);
        ...
        <section class="cart-page">
            <div class="container">
                <div class="cart-total">
                    <h3 class="cart-total__text text-uppercase">Cadeaux: <span class="text-capitalize"> <?php echo $resultc; ?> Items</span></h3><!-- /.cart-total__text -->
                </div><!-- /.cart-total -->
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="cart-update__button-box">
                                <form method="POST" action="AjouterCadeau.php">
                                 <input type="submit" class="thm-btn login-form__btn" value="Ajouter un cadeau"  >
                              </form>
                        ...
                        <table class="cart-table">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td class="modify">                                                
                                        <form method="POST" action="ModifierCadeau.php?id=<?PHP echo $row['id']; ?>">
