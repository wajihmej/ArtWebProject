...
if( isset($_POST['nom']) and isset($_POST['prix']) ){
    ...
    $tableauxC->UpdateImgTableauximg($_GET['id'],$folder);
...
//Partie3
$tableauxC = new TableauxC();
$tableauxC->modifierTableaux($tableaux,$_GET['id']);
    ...
    <div class="page-wrapper">
        ...
        <section class="login-form">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="login-form__title">Modifier Tableau</h3><!-- /.login-form__title -->
                        <form action="#" class="login-form__form" method="post" enctype="multipart/form-data" id="from_tableau" >
                            <div class="login-form__field">
                                <input type="text" name="nom" id="nom" placeholder="Nom" value="<?PHP echo $nom ?>">
                                <i class="fa fa-user"></i>
                            </div><!-- /.login-form__field -->
                            <div class="login-form__field">
                                <input type="number" name="prix" id="prix" placeholder="Prix" value="<?PHP echo $prix ?>">
                                <i class="fa fa-user"></i>
                            </div><!-- /.login-form__field -->
                            <div class="login-form__field">
                                <input type="text" name="informations" id="informations" placeholder="Informations" value="<?PHP echo $informations ?>">
                                <i class="fa fa-user"></i>
                            </div><!-- /.login-form__field -->
                            <div class="login-form__field">
                            ...
                            <div class="login-form__bottom">
                                <input class="thm-btn login-form__btn login-form__btn-two" type="submit" value="Modifier" name="modif" id="modif">
